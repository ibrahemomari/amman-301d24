...
// in arrow function 
const ArrowSumAndProduct=(a,b)=>([a+b,a*b]);
...
// in arrow function 
// they can never be invoked with the new keyword. As such, a prototype property does not exist for an arrow function.
...
Student.ArrowCourseName=()=>('This student is enrolled in Code 301.');
console.log(Student.ArrowCourseName());
...
// i think is referred to object was created.
// 2. What is "this" when joe.scopeArrow() is invoked?
// its referred to golbal object, in this case the global object is windows
// 3. Explain why "this" is different when an arrow function is used.
// the arrow function use the value of 'this' in their lexical scope , This leads to very different behaviour
// 
